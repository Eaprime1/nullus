...
- **Gateway:** THE contains SPHINCTER, the gate mechanism that controls crossing.

The port-of-entry metaphor is deliberately broad: think of a **bazaar, a village gate, an airport**. These are places where:

- Multiple arrivals gather.
- Some are ready to cross; others wait.
- The crossing is witnessed and marked.
...
After passing through SPHINCTER (the gate within THE), content enters MAW — Layer 3. At this point:

- **Official entry has begun.** The threshold has been crossed.
- **Processing is underway.** MAW sorts, orients, and prepares content for canonical integration.
- **The commitment is made.** Returning to ANTE-ESSE from Layer 3 requires a deliberate protocol action.

The airport metaphor: Layer 3 is the customs hall. You have passed through passport control (SPHINCTER). You are in the country. The processing is not yet complete, but the crossing is done.

---

## The Bazaar / Village / Airport Metaphor Expanded
...
| **Village** | The wilderness | The village perimeter | The path to the gate | Inside the walls |

Each metaphor captures the same structure: a space before, a threshold, a crossing, a processing zone, and ultimately the interior.

---

## Relationship to NULLUS Inversion

The port-of-entry model is analogous to — but distinct from — the NULLUS polarity inversion:

| | Port of Entry | NULLUS Inversion |
|---|---|---|
| **Layer 0** | Pure ground | Shadow / pre-creation |
| **Threshold** | SPHINCTER / THE | NULLUS inversion point |
| **Post-crossing** | MAW intake | Polarity flip |
...
*See also: [`docs/architecture.md`](architecture.md) | [`integration/ante-esse/README.md`](../integration/ante-esse/README.md) | [`integration/the/README.md`](../integration/the/README.md) | [`integration/sphincter/README.md`](../integration/sphincter/README.md) | [`integration/maw/README.md`](../integration/maw/README.md)*
